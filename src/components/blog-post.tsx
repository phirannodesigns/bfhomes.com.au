...
//   const { allSanityMetaData } = useStaticQuery(
//     graphql`
//       query {
//         allSanityMetaData {
//           nodes {
...
//   const [siteMetadata] = allSanityMetaData.nodes;
//   return (
//     <article
//       key={post.id}
...
//                   siteMetadata.shareImage.asset.fluid
//                 }
//                 imgStyle={{ objectFit: post.mainImage ? 'cover' : 'contain' }}
//                 className="h-full"
...
//                 }}
//                 key={category.id}
//                 className="px-5 py-2 ml-6 text-xl leading-none text-white transform -translate-y-1/2 button bg-brand-pink border-brand-pink"
//               >
//                 {category.title}.
//               </button>
//             ))}
